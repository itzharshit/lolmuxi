...
from YukkiMusic.utils.database import (add_nonadmin_chat, cleanmode_off, cleanmode_on,
                                       commanddelete_off, commanddelete_on,
                                       get_aud_bit_name, get_authuser, get_authuser_names,
                                       get_playmode, get_playtype, get_vid_bit_name,
                                       is_cleanmode_on, is_commanddelete_on,
...
from YukkiMusic.utils.inline.settings import (audio_quality_markup, auth_users_markup,
...
@app.on_callback_query(
    filters.regex(pattern=r"^(CLEANMODE|COMMANDELMODE|SUGGESTIONCHANGE|VOMODECHANGE)$")
    & ~BANNED_USERS
)
@ActualAdminCB
