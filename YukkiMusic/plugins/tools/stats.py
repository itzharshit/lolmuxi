...
from YukkiMusic.utils.database import (get_global_tops, get_particulars, get_queries,
                                       get_served_chats, get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from YukkiMusic.utils.decorators.language import language, languageCB
from YukkiMusic.utils.inline.stats import (back_stats_buttons, back_stats_markup,
...
async def gstats_global(client, message: Message, _):
    return await message.reply_text("This feature is currently disabled!")
...
async def top_users_ten(client, CallbackQuery: CallbackQuery, _):
    return await CallbackQuery.answer(
        "This feature is currently disabled!", show_alert=True
    )
    ...
    if what in ["Users", "Chats"]:
        for items, count in list_arranged.items():
            ...
            try:
                extract = (
                    (await app.get_users(items)).mention
                    if what == "Users"
